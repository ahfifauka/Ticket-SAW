...
class MasterSkalaLevelUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'level' => 'required|string|max:255|unique:skala_levels,level,' . $this->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'level.max' => 'Level tidak boleh lebih dari 255 karakter.',
